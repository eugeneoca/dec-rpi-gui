...
"background-color: rgb(229, 229, 229);")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/buttons/img/iconfinder_Inkcontober_United_2730360.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius: 10px;")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/buttons/img/iconfinder_sign-check_299110.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.formLayout.setLayout(7, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_8)
