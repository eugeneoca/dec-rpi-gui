...
class Main(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        # Graph Elements
        self.gv_pressure.setLabels(title='Pressure', left='Magnitude')
