...
class Main(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        # Graph Elements
        self.gv_pressure.setLabels(title='Pressure', left='Magnitude', bottom='Time (t) ms')
        ...
        self.gv_flow.setLabels(title='Flow', left='Magnitude', bottom='Time (t) ms')
        self.gv_flow.setAntialiasing(True)
        self.gv_flow.setRange(yRange=[0,30])
        self.gv_flow.setMouseEnabled(x=False, y=False)

        self.gv_volume.setLabels(title='Volume', left='Magnitude', bottom='Time (t) ms')
